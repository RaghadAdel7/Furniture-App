...
function App() {
  ...
  const url1 = `https://e-commerce-furniture-be.onrender.com/api/v1/products`;

  let productsURL = `https://e-commerce-furniture-be.onrender.com/api/v1/products?offset=${offset}&limit=${limit}&search=${userInput}&minPrice=${minPrice}&maxPrice=${maxPrice}`;

  const fetchCategories = async () => {
    try {
      const response = await axios.get(
        "https://e-commerce-furniture-be.onrender.com/api/v1/categories"
      );
  ...
  function getUserData() {
    ...
    axios
      .get(`https://e-commerce-furniture-be.onrender.com/api/v1/users/auth`, {
        headers: {
